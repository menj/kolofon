...
<aside class="wp-block-group menj-callout" style="padding:var(--wp--preset--spacing--40)">
	...
	<p class="has-accent-color has-text-color has-small-font-size"><strong><?php echo esc_html__( 'Note', 'menj-bio' ); ?></strong></p>
	<!-- /wp:paragraph -->

	<!-- wp:paragraph -->
	<p><?php echo esc_html__( 'Replace this with the point worth setting apart from the surrounding argument.', 'menj-bio' ); ?></p>
	<!-- /wp:paragraph -->
</aside>
<!-- /wp:group -->
